...
function countTableRow(inputTable,outputDiv) {
  ...
  console.log("countTableRow function called.",inputTable,outputDiv,"Row count:", rowCount);
}
...
async function loadPeerFromDB() {
    try {
                ...
                <tr>
                    ...
                    <div style="text-align: center; background: #e9f7ef; border: 2px solid #28a745; border-radius: 8px; color: #155724; padding: 15px;">
                        ...
                        <p style="margin-top: 10px; font-size: 1.1em;">
                            No eNG/KDC (6 Core) events observed in the last <strong>${hoursToCheck}</strong> hours.
                        </p>
                    </div>
                    </td>
                </tr>
        ...
        recentLogs.forEach(log => {
            ...
            if (stateLower === "full" || msgLower.includes("to established" ) || msgLower.includes("to up") || msgLower.includes("adjacency_established")) {
                iconGif = "/icons/Event-5.gif"; // Green/Success
            } else if (stateLower === "down" || msgLower.includes("to down") || msgLower.includes("to idle")|| msgLower.includes("to init") || msgLower.includes("adjacency_teardown")) {
                iconGif = "/icons/Event-10.gif"; // Red/Down
            } else {
                iconGif = "/icons/Event-504.gif"; // Grey/Unknown
            }
